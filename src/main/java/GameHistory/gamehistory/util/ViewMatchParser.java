...
public class ViewMatchParser {
    ...
    public ViewMatchDto setViewMatch(int championId, int kills, int deaths, int assists, boolean win, int item0, int item1, int item2, int item3, int item4, int item5) {
